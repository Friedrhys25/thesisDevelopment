...
export default function FAQPage() {
  ...
  const faqs = [
    { q: "How do I submit feedback or a complaint?", a: "Go to the Feedback or Complaints section, fill in the required details including your name, contact information, and description of the issue. You can also attach photos if needed to support your complaint. Once completed, click the submit button." },
    { q: "Can I edit my complaint after submitting?", a: "Yes, you can edit your complaint before it is reviewed or marked as 'In Progress'. Once an administrator has started reviewing it, edits may not be allowed to maintain the integrity of the process." },
    ...
    { q: "Who reviews my complaints or feedback?", a: "Assigned administrators or barangay officials review all submissions. Each complaint is assigned to the appropriate department based on the nature of the issue to ensure proper handling and expertise." },
    ...
    { q: "What should I do if I don't get a response?", a: "If you do not receive a response within 5-7 business days, you can submit a follow-up through the app or contact the barangay office directly during office hours (8 AM - 5 PM, Monday to Friday)." },
    { q: "Can I submit anonymous complaints?", a: "Yes, anonymous complaints are allowed. However, providing your contact information can help us follow up with you for additional details or to inform you when the issue is resolved." },
    ...
    { q: "Can I attach photos to my complaint?", a: "Yes, you can attach up to 5 photos to your complaint. Photos help officials better understand the issue and provide more accurate solutions. Each photo should be under 5MB in size." },
    ...
    { q: "What if my issue requires urgent attention?", a: "When submitting your complaint, you can mark it as 'Urgent'. Urgent complaints are prioritized and reviewed first. For life-threatening emergencies, please contact emergency services directly." },
